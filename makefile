...
tunaplayer: main.o player_window.o tuna_player.o tuna_extracter.o
	g++ `pkg-config --cflags --libs gstreamer-0.10`  `pkg-config --cflags --libs  gtkmm-2.4` -o tunaplayer main.o tuna_player.o player_window.o tuna_extracter.o -ggdb3 -Wall
...
clean:
	rm tunaplayer main.o tuna_player.o player_window.o tuna_extracter.o