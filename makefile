...
tae: main.o player_window.o tuna_player.o tuna_extracter.o
	g++ `pkg-config --cflags --libs gstreamer-0.10`  `pkg-config --cflags --libs  gtkmm-3.0` -o tae main.o tuna_player.o player_window.o tuna_extracter.o -ggdb3 -Wall

main.o: main.cc player_window.hh
	g++ -c `pkg-config --cflags  gstreamer-0.10`  `pkg-config --cflags  gtkmm-3.0` main.cc -ggdb3 -Wall

player_window.o: player_window.cc tuna_player.h tuna_extracter.h
	g++ -c `pkg-config --cflags  gstreamer-0.10`  `pkg-config --cflags  gtkmm-3.0` player_window.cc -ggdb3 -Wall
